        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          <div className="order-2 md:order-1">
            ...
            <div className={`font-mono text-sm leading-relaxed mb-8 text-justify border-l-4 pl-4 ${
              ...
              I love figuring out how things work. All things backend, systems programming, tech , computers  and everything in between. TS/JAVA for work | Go & C for fun | Linux Nerd | Code
            </div>
            
            <div className="flex flex-col sm:flex-row gap-4 font-pixel text-[10px] md:text-xs">
              <a 
                href="https://github.com/madvith-d" 
                target="_blank" 
              ...
              <a 
                href="https://instagram.com/mad.vith" 
                target="_blank"
                rel="noopener noreferrer"
            ...
            <figure className="relative w-full group">
              <div className={`border-4 p-2 transition-all duration-300 group-hover:translate-x-1 group-hover:translate-y-1 ${
                ...
                <Image
                  ...
                  height={500}
                  alt="Madvith Profile" 
                  className={`w-full h-auto pixelated ${isDarkMode ? 'filter hue-rotate-0' : 'filter grayscale contrast-125'}`}
