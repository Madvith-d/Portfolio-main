        ...
        */}
        ...
        <div className={`p-8 border-b-2 lg:border-b-0 ${isDarkMode ? 'bg-zinc-800 border-zinc-100' : 'bg-white border-zinc-900'}`}>
          ...
          <div className={`space-y-8 border-l-4 pl-6 ml-2 ${isDarkMode ? 'border-zinc-600' : 'border-zinc-200'}`}>
            {/* Job 1 - flc Full-Stack Developer */}
            <div className="relative group">
              ...
              <p className="font-mono text-xs mb-2 text-red-700 font-bold uppercase"> Developer</p>
              <p className={`font-sans text-xs leading-relaxed ${isDarkMode ? 'text-zinc-400' : 'text-zinc-600'}`}>
                Building a platform to connect developers with open source projects. Working on backend APIs, database design, and user authentication to create a seamless experience for contributors and maintainers.
              </p>
            </div>
            ...
            <div className="relative group">
              ...
              <p className="font-mono text-xs mb-2 text-red-700 font-bold uppercase">Executive Member</p>
              <p className={`font-sans text-xs leading-relaxed ${isDarkMode ? 'text-zinc-400' : 'text-zinc-600'}`}>
                Organized workshops and coding competitions for students. 
              </p>
            </div>
            ...
            <div className={`relative pt-6 border-t-2 border-dashed mt-8 ${isDarkMode ? 'border-zinc-600' : 'border-zinc-300'}`}>
              ...
              <div className="relative group mb-6">
                ...
                <p className="font-mono text-xs mb-2 text-red-700 font-bold uppercase">Computer Science Engineering</p>
                <p className={`font-sans text-xs leading-relaxed ${isDarkMode ? 'text-zinc-400' : 'text-zinc-600'}`}>
                  Pursuing B.Tech in Computer Science and Engineering with a focus on software development, algorithms, and systems programming. Active member of the coding clubs and tech community on campus.
                </p>
              </div>
              ...
              <div className="relative group">
                ...
                <p className="font-mono text-xs mb-2 text-red-700 font-bold uppercase">Pre-University</p>
                <p className={`font-sans text-xs leading-relaxed ${isDarkMode ? 'text-zinc-400' : 'text-zinc-600'}`}>
                  Completed pre-university education with a focus on science , mathematics and Biology. 
                </p>
              </div>
            </div>
          </div>
        ...
        <div className={`p-8 text-center ${isDarkMode ? 'bg-zinc-100 text-zinc-900' : 'bg-zinc-900 text-white'}`}>
          ...
          <a href="https://github.com/Madvith-d" target="_blank" rel="noopener noreferrer" className={`inline-block border-2 px-6 py-3 font-pixel text-xs uppercase transition-colors shadow-[4px_4px_0px_0px_#888] ${
            isDarkMode
