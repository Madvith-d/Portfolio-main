      ...
      <>
        ...
        <section className={`p-8 border-b-2 transition-colors ${
          ...
          <div className={`w-full overflow-hidden border-2 p-2 shadow-[4px_4px_0px_0px_#ccc] ${
            ...
            <img 
              src={`https://ghchart.rshah.org/${chartColor}/madvith-d`} 
              alt="Madvith's GitHub Contribution Graph" 
          ...
          <div className="relative z-10">
            ...
            <div className="flex justify-center flex-row items-center">
              <div className={`border-2 p-1 col-span-1 transition-all hover:translate-x-1 hover:translate-y-1 ${
                ...
                <img 
                  src={`https://github-readme-stats.vercel.app/api?username=madvith-d&show_icons=true&hide_border=true&hide_rank=true`} 
                  alt="GitHub Stats" 
                  className="w-full"
                />
              </div>
              <div className={`border-2 p-1 transition-all hover:translate-x-1 hover:translate-y-1 ${
                ...
                <img 
                  src={`https://github-readme-stats.vercel.app/api/top-langs/?username=madvith-d&layout=compact&hide_border=true${statsThemeQuery}`} 
                  alt="Top Languages" 
                  className="w-full"
                />
              </div>
            ...
            <div className="text-center mt-6">
              <a href="https://github.com/madvith-d" target="_blank" rel="noopener noreferrer" className={`font-pixel text-[8px] uppercase tracking-widest hover:text-red-700 ${isDarkMode ? 'text-zinc-400' : 'text-zinc-500'}`}>
                [INSERT COIN] &bull; Source: GitHub API &bull; User: @madvith-d
              </a>
            </div>
          </div>
        </section>
